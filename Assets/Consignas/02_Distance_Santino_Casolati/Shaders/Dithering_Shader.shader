...
Shader "Dithering_Shader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_51_0 = length( abs( ( ase_worldPos - _PlayerPos ) ) );
			float2 panner90 = ( 1.0 * _Time.y * _NoiseSpeed + i.uv_texcoord);
			float lerpResult105 = lerp( ( saturate( ( ( distance( (worldToView55).xy , (worldToView59).xy ) - _Radius ) / 0.2 ) ) + saturate( ( ( temp_output_51_0 - _Radius ) / ( 1.0 - _Hardness ) ) ) + tex2D( _NoiseTex, panner90 ).r ) , 1.0 , step( temp_output_51_0 , 0.0 ));
...
/*ASEBEGIN
Version=18900
1410.4;80.8;1175.6;777.4;1392.627;343.3079;1.988328;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;88;88.8275,464.7514;Inherit;False;716.9797;384.7972;Sphere mask 2D;5;85;83;84;82;81;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.CommentaryNode;78;-32.82202,927.2137;Inherit;False;846.2741;428.8372;Sphere mask;7;68;69;74;70;72;73;71;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;71;168.8976,1133.048;Inherit;False;Constant;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;164.8976,1270.048;Inherit;False;Property;_Hardness;Hardness;3;0;Create;True;0;0;0;False;0;False;0.8;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-12.99362,1121.454;Inherit;False;Property;_Radius;Radius;2;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;94;-5.507796,1387.845;Inherit;False;908.987;336.3527;Animated noise;4;92;90;89;91;;1,1,1,1;0;0
Node;AmplifyShaderEditor.LengthOpNode;51;-259.6093,850.8035;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;91;106.7936,1586.407;Inherit;False;Property;_NoiseSpeed;NoiseSpeed;4;0;Create;True;0;0;0;False;0;False;-0.01,0.01;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleSubtractOpNode;72;330.8976,1207.049;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;89;48.56063,1439.879;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;68;183.5537,985.2809;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PannerNode;90;367.6263,1509.859;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;70;511.225,1088.719;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;74;665.2844,1089.524;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;85;667.5096,681.86;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;92;581.6142,1483.077;Inherit;True;Property;_NoiseTex;NoiseTex;5;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleAddOpNode;99;935.8132,972.2031;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
